...
const femaleSVG = (<svg version="1.1" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" overflow="visible"
xmlSpace="preserve">
...
const maleSVG = (<svg version="1.1" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 64 64" overflow="visible"
xmlSpace="preserve">
...
export default function PlayerCard(props: { theme: string, player: Iplayer, selected: boolean, onSelected: React.SetStateAction<any> }){
  
  return (
    <div className={`player_card theme-${ props.theme } ${props.selected && 'selected'}`} onClick={() => props.onSelected(props.player.id) }>
      <div className="image">
        { props.player.gender === 'Female' ? femaleSVG : maleSVG }
      </div>
